...
| **2.1.3 Achievements** | Add awards or certificates you’ve received. | Riya uploads details about winning a state-level science quiz and getting a gold medal. |
...
| **2.1.7 Link Fragments to Documents** | Highlight parts of your profile and link them to your uploaded documents. | In her “Achievements” section, Riya links her debate competition mention to the certificate file. |
...
| **Point** | **Layman Explanation** | **Example** |
|----------|------------------------|-------------|
| **2.2.1 Upload Documents by Section** | Upload documents in organized sections like “Transcripts” or “Internship.” | Riya uploads her 10th and 12th marksheets under the “Transcripts” section and adds her internship letter in “Internship Experience.” |
| **2.2.2 Add Custom Sections** | Create new folders like “Extra-Curricular” if needed. | Riya adds a new section called “Dance Achievements” and uploads her certificates. |
...
| **2.2.4 Tag Primary Document** | Mark the most important version (usually the latest one). | Out of the 3 SOPs, Riya marks the latest one as “primary,” which will be used by default in applications. |
...
#### 📌 For Sponsors (Organizations offering projects)

| **Point** | **Layman Explanation** | **Example** |
|-----------|------------------------|-------------|
| **2.3.1.1 Post project** | Organizations can add new project listings. | A tech NGO posts a "Build a Website for Farmers" project. |
| **2.3.1.2 View applicant profiles** | See which students applied and review their profiles. | The NGO checks Riya’s profile before shortlisting her. |
| **2.3.1.3 Approve applicants** | Accept students into the project. | Riya’s application gets accepted by the sponsor. |
...
| **2.3.1.5 Set milestones** | Set goals or stages for the project. | The sponsor defines 3 stages: Design → Development → Testing. |
...
| **2.3.1.7 Approve submissions** | Review and approve the students’ work. | Riya submits the design and gets it approved by the sponsor. |
...
| **2.3.2.3 See application status** | Check whether you're selected or pending. | Riya sees her status as “Approved.” |
...
### 💬 **2.4. Discussion/Collaboration (Optional Features)**
...
| **2.4.3 Post questions and peers can discuss in the thread** | Post doubts/questions and receive peer answers. | Riya asks, “What is the deadline format we should follow?” and others reply. |
...
### 🎓 **2.5 University Application (Counselor Role)**

| **Point** | **Layman Explanation** | **Example** |
|-----------|------------------------|-------------|
| **2.5.1.1 Add prospective universities** | Counselors can add names of colleges students can apply to. | Riya’s counselor adds Stanford, NYU, and Oxford to the portal. |
...
| **2.5.1.3 Comment at different sections of student’s application** | Counselors can leave feedback directly on the student’s form or essay. | The counselor suggests better wording for Riya’s introduction paragraph. |
...
| **2.5.1.5 Approval of the application** | Counselor gives the final "green light" for application submission. | Once Riya completes everything, her counselor marks the application as “Approved.” |
...
| **2.5.1.7 Send invites to University representatives to view applications** | Invite colleges to log in and see the student profiles. | The counselor sends a secure invite to Harvard’s admission office so they can view shortlisted applications. |

---


### 🎓 **2.5.2 University Application (Student's Role)**
...
| **2.5.2.3 View list of selected universities** | See a list of only those universities you picked. | Riya clicks “My Applications” to view her 5 selected colleges. |
...
| **2.5.2.4.7 Send application** | Submit your completed application to the university. | Once approved by the counselor, Riya clicks “Submit” for her NYU application. |
| **2.5.2.4.8 Status of each application** | See if your application is Submitted, Reviewed, Selected, etc. | Riya checks and sees that her application to UBC is “Under Review.” |

---


### 🎓 **2.5.3 University Representative's Role**
...
| **2.5.3.4 Highlight/select the finalized candidates** | Choose which students are shortlisted or accepted. | Riya’s application is marked “Selected for Interview.” |
| **2.5.3.5 Send info to the selected candidates** | Send emails or notifications to accepted candidates. | Riya receives a message: “Congratulations! You've been shortlisted for the next round.” |

---

### 👨‍👩‍👧 **2.6 Parents/Guardians/Sponsors Login**

| **Point** | **Layman Explanation** | **Example** |
|-----------|------------------------|-------------|
| **2.6.1 Create login for all stakeholders** | Parents, sponsors, counselors, and university staff can all have their own login. | Riya’s mom, her school principal, and a private counselor each have separate logins. |
| **2.6.2 Different views for each role** | Each role sees only the info they need, customized to their responsibilities. | Riya’s mom can view progress only, while the counselor can comment on applications, and the sponsor can view project participation. |
